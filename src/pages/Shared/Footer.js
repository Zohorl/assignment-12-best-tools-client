...
const Footer = () => {
    ...
    return (
        <footer
            ...
            className="">
            <div className='footer pt-56 lg:flex justify-around'>
                <div>
                    <span className="footer-title">Services</span>
                    <a href='https://www.brafton.com/blog/graphics/branding-tools/' className="link link-hover">Branding</a>
                    <a href='https://themeforest.net/' className="link link-hover">Design</a>
            ...
            <div className='pt-12 text-center'>
                <p>Copyright &copy; {year} - All right reserved by <span className='text-xl'>Best Tool</span></p>
            </div>
        </footer>
    );
};
